...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publish_time: Schema.Attribute.Date & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    read_time_text: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiHomePageFeaturedProjectHomePageFeaturedProject
  extends Struct.CollectionTypeSchema {
  collectionName: 'home_page_featured_projects';
  info: {
    displayName: 'HomePageFeaturedProject';
    pluralName: 'home-page-featured-projects';
    singularName: 'home-page-featured-project';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-page-featured-project.home-page-featured-project'
    > &
      Schema.Attribute.Private;
...
export interface ApiHomePageLatestInsightHomePageLatestInsight
  extends Struct.CollectionTypeSchema {
  collectionName: 'home_page_latest_insights';
  info: {
    displayName: 'HomePageLatestInsight';
    pluralName: 'home-page-latest-insights';
    singularName: 'home-page-latest-insight';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-page-latest-insight.home-page-latest-insight'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHomePageMapTextHomePageMapText
  extends Struct.CollectionTypeSchema {
  collectionName: 'home_page_map_texts';
  info: {
    displayName: 'HomePageMapText';
    pluralName: 'home-page-map-texts';
    singularName: 'home-page-map-text';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-page-map-text.home-page-map-text'
    > &
      Schema.Attribute.Private;
    number: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHomeScreenActionVideoHomeScreenActionVideo
  extends Struct.SingleTypeSchema {
  collectionName: 'home_screen_action_videos';
  info: {
    displayName: 'HomeScreenActionVideo';
    pluralName: 'home-screen-action-videos';
    singularName: 'home-screen-action-video';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-screen-action-video.home-screen-action-video'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customer_reviews: Schema.Attribute.Relation<
      'oneToMany',
      'api::customer-review.customer-review'
    >;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
